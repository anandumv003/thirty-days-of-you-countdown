...
const birthdayDate = new Date('2024-07-21'); // Set your friend's birthday date here
const countdownStartDate = new Date('2024-06-21'); // 30 days before birthday
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const daysDiff = Math.floor((today.getTime() - startDate.getTime()) / (1000 * 3600 * 24)) + 1;
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 font-light mb-8">
            A celebration countdown to your most magical birthday
          </p>
