  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-pink-50 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 max-w-7xl">
        ...
        {/* Enhanced romantic calendar grid with her favorite colors and photo previews */}
              ...
              >
                <div
                  className={`
                    ...
                    transition-all duration-700 relative backdrop-blur-sm
                    ${unlocked
                  ...
                  `}
                >
                  {/* Photo Background with Beautiful Effects */}
                  {unlocked && (
                    <div className="absolute inset-0">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-navy-900/60 via-pink-500/20 to-blue-400/30 group-hover:from-navy-900/40 transition-all duration-500"></div>
                      <div className="absolute inset-0 bg-gradient-to-br from-transparent via-white/10 to-pink-200/20 group-hover:to-pink-300/30 transition-all duration-500"></div>
                    </div>
                  )}
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-3 z-10">
                    ...
                    <div className={`text-2xl md:text-3xl font-extralight mb-2 transition-all duration-300 ${
                      unlocked ? 'text-white drop-shadow-lg group-hover:text-pink-100 animate-love-pulse' : 'text-gray-400'
                    }`}>
                      {dayData.day}
                    </div>
                    ...
                    <div className="mb-1">
                      {unlocked ? (
                        <Heart className="w-5 h-5 text-pink-200 opacity-90 group-hover:scale-125 group-hover:text-pink-100 transition-all duration-300 group-hover:rotate-12 fill-current animate-heart-beat drop-shadow-md" />
                      ) : (
                        <Lock className="w-5 h-5 text-gray-400 animate-gentle-bounce" />
                      )}
                    </div>

                    {/* Enhanced day label with romantic animations */}
                    <div className={`text-xs text-center font-light transition-all duration-300 ${
                      unlocked ? 'text-white/90 group-hover:text-pink-100 animate-fade-in drop-shadow-sm' : 'text-gray-400'
                    }`}>
                      Day {dayData.day}
                    </div>
                  </div>
        ...
        <div className="text-center animate-fade-in animate-delay-1000">
          <div className="bg-white/90 backdrop-blur-md rounded-full px-8 py-4 inline-block border border-blue-200/70 shadow-lg hover-romantic animate-love-pulse relative">
